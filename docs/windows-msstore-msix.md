...
요점: **탈락해도 걱정하지 마라.** 거절될 때마다 무엇이 왜 문제인지 친절하고 구체적으로 안내해 주기 때문에, 그대로 고쳐 재제출하면 된다. 다만 첫 통과까지는 시간이 걸리니 출시 데드라인이 있다면 최소 1~2주 버퍼를 두는 게 안전하다.
...
| 심사 | Partner Center | 첫 통과까지 1~2주 버퍼, 탈락해도 사유 친절히 안내 |
